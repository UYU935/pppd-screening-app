...
/** タイプ別の患者向け説明文（軸スコア10点以上で表示） */
export const TYPE_EXPLANATION: Partial<Record<AxisKey, string>> = {
  visual:
    "目から入る情報に脳が強く反応しやすいタイプです。スーパー、人混み、スマホ画面、白い壁などで悪化しやすい傾向があります。",
  posture:
    "立つ、歩く、頭を動かすなどの身体動作で、バランス調整が過敏になりやすいタイプです。",
  closedSpace:
    "トイレ、風呂、美容院、歯科など、狭い・逃げにくい・過去に症状が出た場所で反応しやすいタイプです。",
  anticipatoryAnxiety:
    "「また起きるかも」という予測が症状を強めやすいタイプです。これは気のせいではなく、脳の警戒システムが過敏になっている状態です。",
  avoidance:
    "症状そのものに加えて、避ける行動が増え、生活範囲が狭くなっているタイプです。",
};
